...
__webpack_require__.d(d3_force_src_namespaceObject, "forceCenter", function() { return center; });
__webpack_require__.d(d3_force_src_namespaceObject, "forceCollide", function() { return collide; });
__webpack_require__.d(d3_force_src_namespaceObject, "forceLink", function() { return src_link; });
__webpack_require__.d(d3_force_src_namespaceObject, "forceManyBody", function() { return manyBody; });
__webpack_require__.d(d3_force_src_namespaceObject, "forceRadial", function() { return radial; });
__webpack_require__.d(d3_force_src_namespaceObject, "forceSimulation", function() { return src_simulation; });
__webpack_require__.d(d3_force_src_namespaceObject, "forceX", function() { return d3_force_src_x; });
__webpack_require__.d(d3_force_src_namespaceObject, "forceY", function() { return d3_force_src_y; });
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"06930a58-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/pug-plain-loader!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/svgRenderer.vue?vue&type=template&id=de011c36&lang=pug&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('svg',{ref:"svg",staticClass:"net-svg",attrs:{"xmlns":"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink","width":_vm.size.w,"height":_vm.size.h},on:{"mouseup":function($event){return _vm.emit("dragEnd",[$event])},"&touchend":function($event){return _vm.emit("dragEnd",[$event])},"&touchstart":function($event){}}},[_c('g',{staticClass:"links",attrs:{"id":"l-links"}},_vm._l((_vm.links),function(link){return _c('path',_vm._b({class:_vm.linkClass(link.id),style:(_vm.linkStyle(link)),attrs:{"d":_vm.linkPath(link),"id":link.id},on:{"click":function($event){return _vm.emit("linkClick",[$event,link])},"&touchstart":function($event){return _vm.emit("linkClick",[$event,link])}}},'path',_vm.linkAttrs(link),false))}),0),(!_vm.noNodes)?_c('g',{staticClass:"nodes",attrs:{"id":"l-nodes"}},[_vm._l((_vm.nodes),function(node,key){return [(_vm.svgIcon(node))?_c('svg',_vm._b({key:key,class:_vm.nodeClass(node,["node-svg"]),style:(_vm.nodeStyle(node)),attrs:{"viewBox":_vm.svgIcon(node).attrs.viewBox,"width":_vm.getNodeSize(node, "width"),"height":_vm.getNodeSize(node, "height"),"x":node.x - _vm.getNodeSize(node, "width") / 2,"y":node.y - _vm.getNodeSize(node, "height") / 2,"title":node.name},domProps:{"innerHTML":_vm._s(_vm.svgIcon(node).data)},on:{"click":function($event){return _vm.emit("nodeClick",[$event,node])},"&touchend":function($event){return _vm.emit("nodeClick",[$event,node])},"mousedown":function($event){$event.preventDefault();return _vm.emit("dragStart",[$event,key])},"touchstart":function($event){$event.preventDefault();return _vm.emit("dragStart",[$event,key])}}},'svg',node._svgAttrs,false)):_c('circle',_vm._b({key:key,class:_vm.nodeClass(node),style:(_vm.nodeStyle(node)),attrs:{"r":_vm.getNodeSize(node) / 2,"cx":node.x,"cy":node.y,"title":node.name},on:{"click":function($event){return _vm.emit("nodeClick",[$event,node])},"&touchend":function($event){return _vm.emit("nodeClick",[$event,node])},"mousedown":function($event){$event.preventDefault();return _vm.emit("dragStart",[$event,key])},"touchstart":function($event){$event.preventDefault();return _vm.emit("dragStart",[$event,key])}}},'circle',node._svgAttrs,false))]})],2):_vm._e(),(_vm.linkLabels)?_c('g',{staticClass:"labels",attrs:{"id":"link-labels"}},_vm._l((_vm.links),function(link){return _c('text',{staticClass:"link-label",attrs:{"font-size":_vm.fontSize}},[_c('textPath',{attrs:{"xlink:href":'#' + link.id,"startOffset":"50%"}},[_vm._v(_vm._s(link.name))])])}),0):_vm._e(),(_vm.nodeLabels)?_c('g',{staticClass:"labels",attrs:{"id":"node-labels"}},_vm._l((_vm.nodes),function(node){return _c('text',{staticClass:"node-label",class:(node._labelClass) ? node._labelClass : "",attrs:{"x":_vm.getLabelX(node),"y":node.y + _vm.labelOffset.y,"font-size":_vm.fontSize,"stroke-width":_vm.fontSize / 8,"text-anchor":node.labelCenter === true ? "middle" : "start"}},[_vm._v(_vm._s(node.name))])}),0):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/svgRenderer.vue?vue&type=template&id=de011c36&lang=pug&
...
/* harmony default export */ var svgRenderervue_type_script_lang_js_ = ({
  name: 'svg-renderer',
  props: ['size', 'nodes', 'noNodes', 'selected', 'linksSelected', 'links', 'nodeSize', 'padding', 'fontSize', 'strLinks', 'linkWidth', 'nodeLabels', 'linkLabels', 'labelOffset', 'nodeSym', 'labelCenter'],
  computed: {
  ...
  methods: {
    getLabelX: function getLabelX(node) {
      if (node.labelCenter) {
        return node.x;
      }

      return node.x + this.getNodeSize(node) / 2 + this.fontSize / 2;
    },
...
// CONCATENATED MODULE: ./src/components/canvasRenderer.vue?vue&type=template&id=15b33650&lang=pug&
...
/* harmony default export */ var canvasRenderervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    mapShape: function mapShape(shape, type, drawFunc, hitCtx) {
      ...
      var nShape = Object.assign({}, shape);
    ...
    loadNodeStyle: function loadNodeStyle(node) {
      ...
      if (node._cssClass) {
        ...
        if (!this.styles[name]) {
          var cStyle = Object.assign({}, this.styles[styleName] || {});
      ...
      var style = Object.assign({}, this.styles[styleName] || this.updateStyle(styleName));
...
var canvasRenderer_component = normalizeComponent(
  ...
  canvasRenderervue_type_template_id_15b33650_lang_pug_render,
...
var d3 = Object.assign({}, d3_force_src_namespaceObject);
/* harmony default export */ var vue_d3_networkvue_type_script_lang_js_ = ({
  ...
  render: function render(createElement) {
    ...
    for (var _i = 0, _bindProps = bindProps; _i < _bindProps.length; _i++) {
      var prop = _bindProps[_i];
...
//# sourceMappingURL=vue-d3-network.umd.js.map